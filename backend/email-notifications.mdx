...
description: "How Amigo Invisible sends personalized Secret Santa reveal emails via Nodemailer and Gmail SMTP — transporter config, email template, and setup steps."
---
