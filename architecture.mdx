---
title: "Amigo Invisible Architecture: Frontend, Backend, and Data Flow"
...
1. **The organizer fills out the group form** in the Angular `Grupo` component — group name, optional budget, optional delivery date, and the participant list with any exclusions.
