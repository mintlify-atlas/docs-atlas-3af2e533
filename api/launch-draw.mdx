...
description: "POST /api/sorteos/:adminToken/lanzar — Runs the Secret Santa algorithm, saves pairings to MongoDB, and sends personalized reveal emails to all participants."
---
