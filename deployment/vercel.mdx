---
title: "Deploy Amigo Invisible Frontend and Backend to Vercel"
sidebarTitle: "Vercel"
description: "Set up two Vercel projects for Amigo Invisible — one for the Angular SPA and one for the Node.js backend — with build and environment configuration."
---
...
<Steps>
  ...
  <Step title="Add environment variables">
    ...
    Setting `NODE_ENV=production` tells the Express app to skip `app.listen()` so the module exports cleanly as a serverless function handler. See the [Environment Variables](/deployment/environment) page for details on how to obtain each value.
  </Step>
