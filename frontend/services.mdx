---
title: "GrupoService: HTTP Client for the Amigo Invisible Backend"
sidebarTitle: "Services"
description: "GrupoService is the Angular injectable that wraps all HTTP calls to the Amigo Invisible REST API — create a group, retrieve data, and launch the draw."
---
