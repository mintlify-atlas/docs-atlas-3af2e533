---
title: "Routing in the Amigo Invisible Angular App"
sidebarTitle: "Routing"
description: "How Angular Router is configured in Amigo Invisible — the two application routes, navigation guards, and how state is passed between components."
---
